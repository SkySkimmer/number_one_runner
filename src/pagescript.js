...
function N1Bot() {
  ...
  console.log("page sending data to runner:" + txts);

  var sent = browser.runtime.sendMessage(txts);
  ...
  var selectors = document.forms["maction"].querySelectorAll("select");
  
  var handleResponse = function(data) {
      console.log("page got data from runner");
    ...
    sent.then(handleResponse, function (e) { console.log('bvsn1runner: got error response'); } );
}
